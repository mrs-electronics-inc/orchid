...
func buildCreateVMUserData(vmName, repoName, repoHost, repoURL, publicKey, privateKey string) string {
	...
	b.WriteString("  - path: /home/dev/.ssh/authorized_keys\n")
	...
	b.WriteString("  - |\n")
	b.WriteString("      install -d -m 0700 -o dev -g dev /home/dev/.ssh\n")
	b.WriteString("      cat > /home/dev/.ssh/authorized_keys <<'ORCHID_AUTHKEY'\n")
	b.WriteString("      ")
	b.WriteString(publicKey)
	b.WriteString("\n")
	b.WriteString("      ORCHID_AUTHKEY\n")
	b.WriteString("      chmod 0600 /home/dev/.ssh/authorized_keys\n")
